...
export default function Home() {
      ...
      const fetchAll = async() => {
        try{
          const [userRes, workoutRes, mealRes] = await Promise.all([
            ...
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/workouts`,{credentials:"include"}),
            fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/nutrition`,{credentials:"include"}),
          ]);
    ...
    const handleAIRequest = async () => {
      ...
      try {
        ...
        const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/api/ai/recommendations`, {
          method: "POST",
          credentials: "include",
